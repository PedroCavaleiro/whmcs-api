...
using static WHMCS_API.Extensions.StringExts;

namespace WHMCS_API.Models.UpdateClientProduct
{
	public class UpdateClientProduct
	{
		public readonly NameValueCollection nvm;
		public UpdateClientProduct(int ServiceID, int PackageID = -1, int ServerID = -1, DateTime NextDueDate = default,
								   DateTime TerminationDate = default(DateTime), DateTime CompletedDate = default,
								   ...
								   NameValueCollection CustomFields = null, NameValueCollection ConfigurationOptions = null)
		{
			...
			if (CustomFields != null)
				nvm.Add(EnumUtil.GetString(APIEnums.UpdateClientProductParams.CustomFields), JsonConvert.SerializeObject(CustomFields).EncodeToBase64());
			if (ConfigurationOptions != null)
				nvm.Add(EnumUtil.GetString(APIEnums.UpdateClientProductParams.ConfigurationOptions), JsonConvert.SerializeObject(ConfigurationOptions).EncodeToBase64());
		}
	}
}
